...
def main():
    ...
    if args.n_gpu > 1:
        ...
        logging.info("Number of GPUs: {}, using DataParallel.".format(args.n_gpu))
    ...
    if args.local_rank != -1 and cfg.distributed:
        ...
        logging.info("Number of GPUs: {}, using DistributedDataParallel.".format(args.num_gpus))
        ...
        for epoch in range(start_epoch, cfg.OPTIM.EPOCHS):
            ...
            if is_best:
                ...
                if cfg.OPTIM.OPT in ['salsa']:
                    ...
                    logging.info("Switch due to overfitting!")
